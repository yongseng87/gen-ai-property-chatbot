...
generate_tenancy_agreement("HDB FLAT", "2 ROOM", "HDBflat_whole", "landlord_name", "tenant_name", "rental_address", "monthly_rent")
generate_tenancy_agreement("HDB FLAT", "1 BEDROOM", "HDBflat_bedroom", "landlord_name", "tenant_name", "rental_address", "monthly_rent")
generate_tenancy_agreement("CONDO / PRIVATE APARTMENT", "3 ROOM", "Condo", "landlord_name", "tenant_name", "rental_address", "monthly_rent")
generate_tenancy_agreement("LANDED", "TERRACE HOUSE", "Landed", "landlord_name", "tenant_name", "rental_address", "monthly_rent")