...
def generate_tenancy_agreement(property_type, rental_type, ref_no, landlord_name, tenant_name, rental_address, monthly_rent):
    ...
    landlord_email = landlord_name.replace(" ", "_") + "@gmail.com"
    ...
    if property_type == "HDB FLAT":
        item_excess = "200"
    elif property_type == "CONDO / PRIVATE APARTMENT":
        item_excess = "500"
    else:
        item_excess = "1000"
    ...
    def bold_all(text, pdf, font_size=10):
        ...
        pdf.write(5, text)
        pdf.set_font("Helvetica", size=font_size)   # Reset to normal font after writing bold text
